    ...
    <div className='w-full min-h-screen bg-white flex items-center justify-center'>
      <div className='w-11/12 max-w-7xl flex mx-auto p-4 md:p-8'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
          <div className='flex flex-col gap-7 p-2 md:p-6'>
            <div className='text-4xl md:text-5xl font-semibold'>About Us</div>
            <div className='font-light text-base md:text-xl text-gray-500'>
            ...
            <div className='flex flex-col sm:flex-row gap-6'>
              <div className='flex flex-col gap-3'>
                ...
                <div className='text-md md:text-lg text-gray-600'>Web & Mobile Specialties</div>
                <div className='font-light text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis quis consect.</div>
                <div className='text-teal-300 cursor-pointer'>Learn more</div>
              </div>
              <div className='flex flex-col gap-3'>
                <div className='text-4xl md:text-5xl text-gray-500'><IoExtensionPuzzleSharp /></div>
                <div className='text-md md:text-lg text-gray-600'>Intuitive Thinkers</div>
                <div className='font-light text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis quis consect.</div>
                <div className='text-teal-300 cursor-pointer'>Learn more</div>
              </div>
            </div>
